...
redirect_from:
  - nlp(natural%20language%20processing)%20/%20rnns/2021/06/14/ERNIE
  - nlp(natural language processing) / rnns/2021/06/14/ERNIE
  - NLP(Natural Language Processing) / RNNs/2021/06/14/ERNIE
author: YouWon
categories: 
...
단어표현을 연속적인 벡터로 표현하는 방식을 긴 역사를 가지고 있다. 2003년 NNLM에서는 MLP를 사용하여 단어 벡터표현을 학습하였다.  
