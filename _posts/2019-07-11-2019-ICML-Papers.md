...
개요 | 내용
:--------: | -------- 
저자     | *Francesco Locatello, Stefan Bauer, Mario Lucic, Gunnar Rätsch, Sylvain Gelly, Bernhard Schölkopf, Olivier Bachem*, Google Research
논문 | <https://arxiv.org/abs/1811.12359>
소스코드  | <>
...
이 논문에서, 풀린 표현의 무감독 학습은 모델과 데이터 모두에 대해 귀납적 편향(inductive biases) 없이는 본질적으로 불가능하다는 것을 이론적으로 보일 것이다. 또한 여러 데이터셋에 대해 대부분의 중요한 방법을 다루는 12000개 이상의 모델을 갖고 실험적 연구를 수행할 것이다.  

이로써 

- 여러 방법들이 '대응되는 loss에 의한' 성질들을 강제함에도 불구하고 잘 풀린(well-disentangled) 모델은 감독 없이는 식별될 수 없다는 사실과, 
...
## Rates of Convergence for Sparse Variational Gaussian Process Regressio

개요 | 내용
:--------: | -------- 
저자     | *David R. Burt, Carl E. Rasmussen, Mark van der Wilk*, University of Cambridge and PROWLER. io
논문 | <https://arxiv.org/abs/1903.03571>
소스코드  | <>
...
논문 | <https://arxiv.org/abs/1901.06656>
