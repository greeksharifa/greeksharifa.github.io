...
**torch_geomectric**에서 `GDC`를 사용하는 방법에 대해서 간단하게 [Github](https://github.com/ocasoyy/pytorch_graph_neural_networks)에 올려두었으니 참고해도 좋을 것이다.  
...
<center><img src="/public/img/Machine_Learning/2021-08-12-GDCN/01.PNG" width="70%"></center>  

<center><img src="/public/img/Machine_Learning/2021-08-12-GDCN/02.PNG" width="70%"></center>  
...
<center><img src="/public/img/Machine_Learning/2021-08-12-GDCN/03.PNG" width="70%"></center>  


---
## 4. 결론  
`GDC`는 spetral한 방법론의 장점을 취하면서도 단점은 취하지 않는다는 특징을 지닌다. `GDC`가 기초로하는 가정은 **homophily**가 만족한다 인데, 이 가정이 통하지 않는 데이터셋에는 경우에 따라 효과적이지 못할 수 있다.  

적은 수의 Hyper-paramter를 갖고 있고 응용 범위가 넓기 때문에 다양한 데이터셋과 환경에서 실험 요소로 적극 활용할 수 있을 것으로 보인다.  
