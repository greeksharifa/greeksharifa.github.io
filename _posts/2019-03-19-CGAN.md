...
많은 GAN들(Semi-supervised GAN, catGAN, ACGAN, LSGAN, WGAN, WGAN_GP, DRAGAN, infoGAN, EBGAN, BEGAN, SGAN 등)에 대한 설명은 [여기](https://greeksharifa.github.io/generative%20model/2019/03/20/advanced-GANs/), f-GAN에 대한 설명은 [여기](https://greeksharifa.github.io/generative%20model/2019/03/19/f-GAN/)에서 진행하도록 하겠다.
