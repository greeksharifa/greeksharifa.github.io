...
Implicit 라이브러리는 [이곳](https://github.com/benfred/implicit)에서 확인할 수 있다. 본 장은 간략하게 메서드를 사용하는 방법에 대해서만 소개할 것이다. 학습의 자세한 부분에 대해서는 [이전 글](2020-06-01-LightFM.md)을 참조하길 바란다. 기본적인 틀은 유사하다.  
