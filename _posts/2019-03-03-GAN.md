...
많은 GAN들(DCGAN, LSGAN, WGAN, WGAN_GP, DRAGAN, CGAN, infoGAN, ACGAN, EBGAN, BEGAN 등)에 대한 설명은 [여기]()에서, DCGAN에 대해서는 [다음 글](https://greeksharifa.github.io/paper_review/2019/03/18/DCGAN/)에서 진행하도록 하겠다.
