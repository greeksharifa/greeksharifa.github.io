...
많은 GAN들(LSGAN, WGAN, WGAN_GP, DRAGAN, infoGAN, ACGAN, EBGAN, BEGAN 등)에 대한 설명은 [여기](https://greeksharifa.github.io/generative%20model/2019/03/20/advanced-GANs/)에서, CGAN에 대한 설명은 [다음 글](https://greeksharifa.github.io/generative%20model/2019/03/19/CGAN/)에서 진행하도록 하겠다.
