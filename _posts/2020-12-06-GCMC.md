...
더욱 확장하기 위해서는 효율적인 근사 방법이 필요한데, 예를 들어 Local Neighborhood를 Sub-sampling하는 방법이 그 예가 될 수 있을 것이다. 이 방법에 대해서는 [Inductive Representation Learningon Large Graphs](https://arxiv.org/abs/1706.02216)라는 논문을 참고하길 바란다. 추후에 이 블로그에서도 다룰 수 있도록 하겠다.  
